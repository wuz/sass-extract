...
function verifyBasic(rendered, sourceFile, explicit, mixed, expectedEol = EOL) {
  const declarationLength = explicit ? 2 : 1;
  ...
  expect(rendered.vars.global.$number1.declarations).to.have.length(declarationLength);
  expect(rendered.vars.global.$number1.declarations[declarationLength - 1].expression).to.equal(
  ...
  expect(rendered.vars.global.$number2.declarations).to.have.length(declarationLength);
  expect(rendered.vars.global.$number2.declarations[declarationLength - 1].expression).to.equal(
  ...
  expect(rendered.vars.global.$color.declarations).to.have.length(mixed ? 2 : declarationLength);
  expect(
    rendered.vars.global.$color.declarations[mixed ? 1 : declarationLength - 1].expression
  ).to.equal(`get-color()${explicit || mixed ? ' !global' : ''}`);
  if (explicit || mixed) {
  ...
  expect(rendered.vars.global.$list.declarations).to.have.length(declarationLength);
  expect(rendered.vars.global.$list.declarations[declarationLength - 1].expression).to.equal(
  ...
  expect(rendered.vars.global.$listComma.declarations).to.have.length(declarationLength);
  expect(rendered.vars.global.$listComma.declarations[declarationLength - 1].expression).to.equal(
  ...
  expect(rendered.vars.global.$string.declarations).to.have.length(declarationLength);
  expect(rendered.vars.global.$string.declarations[declarationLength - 1].expression).to.equal(
  ...
  expect(rendered.vars.global.$boolean.declarations).to.have.length(declarationLength);
  expect(rendered.vars.global.$boolean.declarations[declarationLength - 1].expression).to.equal(
  ...
  expect(rendered.vars.global.$null.declarations).to.have.length(declarationLength);
  expect(rendered.vars.global.$null.declarations[declarationLength - 1].expression).to.equal(
  ...
  expect(rendered.vars.global.$map.declarations).to.have.length(declarationLength);
  expect(rendered.vars.global.$map.declarations[declarationLength - 1].expression).to.be.oneOf([
